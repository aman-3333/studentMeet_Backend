...
const userSchema = new Schema(
  {
    ...
    profectionDomain:{type:Schema.Types.ObjectId,ref:"academysubtypes"},
    profection:{type:Schema.Types.ObjectId,ref:"academytypes"},
    academy_id:{type:Schema.Types.ObjectId,ref:"academies"},
