...
router.post("/create", async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json(successResponse("create Stage", response, res.statusCode));
  } catch (error) {
...
router.get("/list", async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json(successResponse("Stage list", response, res.statusCode));
  } catch (error) {
...
router.post("/delete", async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json(successResponse("deleteStage", response, res.statusCode));
  } catch (error) {
